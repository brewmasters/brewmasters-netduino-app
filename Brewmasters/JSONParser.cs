...
using System.Text;
using Brewmasters.Strings;
using Brewmasters.Integer;

namespace Brewmasters.Json
{
	/// <summary>
	...
	public class JsonParser
	{
		...
		{
			Brewmasters.Strings.StringBuilder s = new Brewmasters.Strings.StringBuilder(BUILDER_CAPACITY);
			char c;
		...
		protected static bool SerializeValue(object value, Brewmasters.Strings.StringBuilder builder)
		{
			bool success = true;
		...
		protected static bool SerializeObject(Hashtable anObject, Brewmasters.Strings.StringBuilder builder)
		{
			builder.Append("{");
		...
		protected static bool SerializeArray(ArrayList anArray, Brewmasters.Strings.StringBuilder builder)
		{
			builder.Append("[");
		...
		protected static bool SerializeString(string aString, Brewmasters.Strings.StringBuilder builder)
		{
			builder.Append("\"");
		...
		protected static bool SerializeNumber(double number, Brewmasters.Strings.StringBuilder builder)
		{
